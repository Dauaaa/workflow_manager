  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className={cn("gradient-background flex flex-col justify-center cursor-pointer hover:border-2 hover:border-accent", cardClassName)}>
      ...
      <DialogContent className="flex flex-col gap-4 border-0">
          ...
          <DialogDescription>Input data for new workflow. Press enter to submit.</DialogDescription>
            <NewWorkflowForm
