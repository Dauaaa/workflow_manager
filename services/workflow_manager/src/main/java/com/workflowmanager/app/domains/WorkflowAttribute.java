...
public class WorkflowAttribute {
    @EmbeddedId
    private WorkflowAttributeId id;
    ...
    public WorkflowAttribute(WorkflowAttributeDescription description, Workflow workflow, WorkflowState state, WorkflowEntity entity, List<Long> integer, List<Double> floating, List<String> enumeration, List<BigDecimal> decimal, List<Currency> currency, List<Date> date, List<Instant> timestamp, List<Boolean> flag, List<String> text) {
    ...
    public List<Long> getInteger() { return this.integer; }
    public List<Double> getFloating() { return this.floating; }
    public List<String> getEnumeration() { return this.enumeration; }
    public List<BigDecimal> getDecimal() { return this.decimal; }
    public List<Currency> getCurrency() { return this.currency; }
    public List<Date> getDate() { return this.date; }
    public List<Instant> getTimestamp() { return this.timestamp; }
    public List<Boolean> getFlag() { return this.flag; }
