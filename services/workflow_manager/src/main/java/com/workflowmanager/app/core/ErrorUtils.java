...
public class ErrorUtils {
    ...
    public static <T> void serverAssertEq(T lfs, T rhs, String message) throws ResponseStatusException {
        if (lfs == null && rhs == null) {
            return;
        }
    ...
    public static <T> void serverAssertNeq(T lfs, T rhs, String message) throws ResponseStatusException {
        if (lfs == null && rhs != null || lfs != null && rhs == null) {
            return;
        }
