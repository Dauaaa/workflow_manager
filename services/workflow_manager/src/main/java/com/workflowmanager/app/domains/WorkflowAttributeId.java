...
public class WorkflowAttributeId implements Serializable {
    ...
    public WorkflowAttributeId(WorkflowAttributeDescription description, Workflow workflow, WorkflowState state, WorkflowEntity entity) {
    ...
    public WorkflowEntity getEntity() { return entity; }
    public Workflow getWorkflow() { return this.workflow; }
    public WorkflowState getState() { return this.state; }
